package com.quick.jsbridge.util.device;
...
import com.quick.jsbridge.util.io.FileSavePath;
...
public class PhotoSelector {
     ...
     * @param requestCode
     */
    public void requestSysCamera(Context context,Activity activity, int requestCode) {
        requestCamaraPath = getPhotoTmpPath();
        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intent.putExtra(MediaStore.Images.Media.ORIENTATION, 0);

        File cameraPhoto = new File(requestCamaraPath);
     ...
     * @param requestCode
     */
    public void requestSysCamera(Context context,android.support.v4.app.Fragment fragment, int requestCode) {
        requestCamaraPath = getPhotoTmpPath();
        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intent.putExtra(MediaStore.Images.Media.ORIENTATION, 0);
     ...
     * @param requestCode
     */
    public void requestSysCamera(Context context,Fragment fragment, int requestCode) {
        requestCamaraPath = getPhotoTmpPath();
        Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
        intent.putExtra(MediaStore.Images.Media.ORIENTATION, 0);
     ...
     * @param requestCode
     */
    public void requestSysCamera( Context context,Object fragment, int requestCode) {
        if (fragment instanceof Fragment) {
            requestSysCamera(context,(Fragment) fragment, requestCode);
        } else if (fragment instanceof android.support.v4.app.Fragment) {
            requestSysCamera(context,(android.support.v4.app.Fragment) fragment, requestCode);
        }
    }
