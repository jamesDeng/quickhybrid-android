...
public class WebloaderControl implements IActivityResult, SegActionCallBack, DownloadListener {
    ...
    public WebloaderControl(IQuickFragment quickFragment, QuickBean bean, QuickWebView wv,IFileChooseActivity fileChooseActivity) {
    ...
    private void initWebView() {
        pageLoad = new PageLoad(quickFragment,fileChooseActivity,STATUS_PAGE_ERROR,STATUS_TIMEOUT_ERROR);
