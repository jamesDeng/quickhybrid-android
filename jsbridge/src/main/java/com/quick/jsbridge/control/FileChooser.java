...
public class FileChooser implements IFileChooser {
    ...
    private IFileChooseActivity fileChooseActivity;

    public FileChooser(IQuickFragment fragment,IFileChooseActivity fileChooseActivity) {
        this.fragment = fragment;
        this.fileChooseActivity = fileChooseActivity;
    ...
    public void dealOpenFileChooser(String acceptType) {
        ...
        if (items.length == 1) {
            if (cameraTtile.equals(items[0])) {
                photoSelector.requestSysCamera(fragment.getPageControl().getContext(),fragment.getPageControl().getFragment(), CAMERA_REQUEST_CODE);
        ...
        menuView.setItemClickListener(new ActionSheet.MenusItemClickListener() {
            ...
            public void onItemClick(int index, View btn) {
                ...
                if (imageTitle.equals(title)) {
                    ...
                    photoSelector.requestSysCamera(fragment.getPageControl().getContext(),fragment, CAMERA_REQUEST_CODE);
